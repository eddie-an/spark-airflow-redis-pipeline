...
output_path = os.path.join(BASE_DIR, "../../part1/data/processed")
csv_path = os.path.join(BASE_DIR, f'../../part1/data/raw/0/orders_0.csv')
...
for i in range(1, 7):
    csv_path = os.path.join(BASE_DIR, f'../../part1/data/raw/{i}/orders_{i}.csv')
